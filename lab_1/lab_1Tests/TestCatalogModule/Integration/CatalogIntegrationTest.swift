...
class CatalogIntegrationTest: XCTestCase {
    ...
    func testFetchProducts() throws {
        ...
        // Act
        coreDataManagerTst.addProductToCatalog(product: product1)
        coreDataManagerTst.addProductToCatalog(product: product2)
        let products = coreDataManagerTst.getCatalog()
    ...
    func testAddProduct() throws {
        ...
        // Act
        coreDataManagerTst.addProductToCatalog(product: product)
        let products = coreDataManagerTst.getCatalog()
    ...
    func testDeleteProduct() throws {
        ...
        coreDataManagerTst.addProductToCatalog(product: product)
        // fetch DB
        var products = coreDataManagerTst.getCatalog()
        XCTAssertNotEqual(products.count, 0)
        
        coreDataManagerTst.deleteProductFromCatalog(product: products.first!)
        
        // Assert
        // refetch DB
        products = coreDataManagerTst.getCatalog()
